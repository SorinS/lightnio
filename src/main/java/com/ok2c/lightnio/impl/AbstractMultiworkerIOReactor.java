...
public abstract class AbstractMultiworkerIOReactor implements IOReactor {
    ...
    protected final long gracePeriod;
    ...
    public AbstractMultiworkerIOReactor(
        ...
        this.selectTimeout = config.getSelectInterval();
        this.interestOpsQueueing = config.isInterestOpsQueueing();
        this.gracePeriod = config.getGracePeriod();
        this.tcpNoDelay = config.isTcpNoDelay();
        this.soLinger = config.getSoLinger();
    ...
    protected void prepareSocket(final Socket socket) throws IOException {
        ...
        if (this.soLinger >= 0) {
            socket.setSoLinger(this.soLinger > 0, this.soLinger);
        }
    }
