...
public class NoOpSimpleProtocolHandler implements SimpleProtocolHandler {
    ...
    public void exception(IOSession session, SimpleTestState state, Exception ex) {
    }

    public void inputReady(IOSession session, SimpleTestState state) throws IOException {
    }
